...
const login = async () => {
  try {
    ...
    if (data.success) {
      //Si la autenticación es exitosa, guardar los datos en el store
    ...
    errorMessage.value = 'Error de autenticación. Intenta de nuevo.'
  }
}
</script>
